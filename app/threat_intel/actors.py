...
class ThreatActorIntelligence:
    ...
    DEFAULT_ACTORS = {
        ...
        "China": [
            ...
            },
            {
                "name": "APT1",
                "mitre_id": "G0006",
                "alias": "Comment Crew, Group 93, Byzantine Candor",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Aerospace, Telecom",
                "target_geo": "US, Europe, East Asia",
                "ttps": "T1190 - Exploit Public-Facing Application, T1059 - Command and Scripting Interpreter, T1083 - File Discovery, T1005 - Data from Local System",
                "associated_malware": "Spyder, HTTPBrowser",
                "associated_tools": "Cobalt Strike, Metasploit",
                "first_observed": "2006",
                "description": "Chinese MSS-linked group. One of the oldest known APT groups. Targets government and defense contractors.",
                "risk_level": "critical",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT2",
                "mitre_id": "G0037",
                "alias": "APT-C-02, MossAg, Group 35",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                ...
                "associated_malware": "Hubload, LATEON",
                "associated_tools": "Metasploit",
                "first_observed": "2010",
                "description": "Chinese threat actor linked to espionage operations.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT3",
                "mitre_id": "G0022",
                "alias": "Tempora, TG-6330, Gothic Panda, Pirate Panda",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Defense, Aerospace, Government",
                "target_geo": "US, Europe, Asia",
                "ttps": "T1190 - Exploit Public-Facing Application, T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "KillerBee, PixieMage",
                "associated_tools": "Custom RATs",
                "first_observed": "2011",
                "description": "Chinese state-sponsored group targeting aerospace and defense.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Narciso",
                "associated_tools": "Custom tools",
                "first_observed": "2012",
                "description": "Chinese threat group targeting government sectors.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT12",
                "mitre_id": "G0004",
                "alias": "Mogwai, Dyness, Moniker",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Media, Tech",
                "target_geo": "US, Europe, Asia",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter, T1078 - Valid Accounts",
                "associated_malware": "Mogwai, Sysprint",
                "associated_tools": "Custom RATs",
                "first_observed": "2008",
                "description": "Chinese MSS-linked group targeting media and tech.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "Seeker",
                "associated_tools": "Custom tools",
                "first_observed": "2013",
                "description": "Chinese group targeting government entities.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT16",
                "mitre_id": "G0024",
                "alias": "Emperor Dragon, Radio Elephant",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Media, Dissidents",
                "target_geo": "US, Taiwan, Hong Kong",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter, T1078 - Valid Accounts",
                "associated_malware": "Tonto, Papworth",
                "associated_tools": "Custom RATs",
                "first_observed": "2012",
                "description": "Chinese group targeting dissidents and media.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT19",
                "mitre_id": "G0073",
                "alias": "Cobalt Ugly, Black Barley",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Healthcare",
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Bakstro, Laten",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2015",
                "description": "Chinese threat actor targeting healthcare and defense.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT22",
                "alias": "MUSTANG PANDA, Lead",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Think Tanks",
                "target_geo": "US, Europe, Southeast Asia",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter, T1105 - Ingress Tool Transfer",
                "associated_malware": "Tonto, Mustang Panda",
                "associated_tools": "Cobalt Strike, Mimikatz",
                "first_observed": "2017",
                "description": "Chinese group targeting think tanks and NGOs.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT23",
                "alias": "Cyber-117, Taft",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Aerospace",
                "target_geo": "US, Middle East",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "Kaba, Duran",
                "associated_tools": "Custom tools",
                "first_observed": "2015",
                "description": "Chinese actor targeting aerospace and defense.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT26",
                "alias": "Titan Panda, Emperor Panda",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Healthcare",
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Uranium",
                "associated_tools": "Custom RATs",
                "first_observed": "2016",
                "description": "Chinese group targeting defense contractors.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT31",
                "mitre_id": "G0012",
                "alias": "Matrix, Hajime, TG-3390",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Think Tanks",
                "target_geo": "US, Europe, Asia",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application, T1078 - Valid Accounts",
                "associated_malware": "Remex, Tonto",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2014",
                "description": "Chinese state-sponsored group targeting policy think tanks.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "APT37",
                "mitre_id": "G0067",
                "alias": "Reaper, Group 123, Rimbu, ZINC",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Healthcare, Media",
                "target_geo": "US, Korea, Japan",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application, T1059 - Command and Scripting Interpreter",
                "associated_malware": "RIMEX, GOOOGLE, Retro",
                "associated_tools": "Custom RATs",
                "first_observed": "2016",
                "description": "Chinese group targeting South Korean entities.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "associated_malware": "Krypton",
                "associated_tools": "Metasploit",
                "first_observed": "2017",
                "description": "Chinese threat group targeting aerospace.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "alias": "Newscaster, NewsB, Parastoo",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Defense, Government, Media",
                "target_geo": "US, Middle East",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Matriarch, POWERSTAR",
                "associated_tools": "Custom tools",
                "first_observed": "2011",
                "description": "Iranian group targeting defense contractors. Sometimes misattributed to China.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "Barium",
                "alias": "Winnti subgroup",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Tech, Gaming, Software",
                "target_geo": "Southeast Asia, US",
                "ttps": "T1190 - Exploit Public-Facing Application, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Winnti variants",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2011",
                "description": "Chinese subgroup linked to supply chain attacks on gaming companies.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "Wicked Panda",
                "alias": "APT41 subgroup",
                "actor_type": "State-sponsored",
                "motivation": "Espionage + Financial",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Healthcare, Pharma, Tech",
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "ShadowPad, Spyder",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2013",
                "description": "Chinese group targeting healthcare and tech.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_geo": "Asia, US",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Tonto, Spyder",
                "associated_tools": "Metasploit",
                "first_observed": "2012",
                "description": "Chinese group targeting government sectors.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Tech",
                "target_geo": "US, Europe, Middle East",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Sysupdate, Chrome-eb",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2010",
                "description": "Chinese group commonly conflated with other APT groups.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "Smanager",
                "associated_tools": "Custom RATs",
                "first_observed": "2015",
                "description": "Chinese threat actor targeting government entities.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense",
                "target_geo": "Southeast Asia",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "BACKSPACE",
                "associated_tools": "Custom tools",
                "first_observed": "2013",
                "description": "Chinese group targeting government.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "Molerats",
                "alias": "Gaza Hackers Team, MoleRAT",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Media, Think Tanks",
                "target_geo": "Middle East, US",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "MoleRAT",
                "associated_tools": "Custom RATs",
                "first_observed": "2013",
                "description": "Sometimes attributed to China, targets Middle Eastern entities.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "Volatile Cedar",
                "alias": "Volatile Cedar",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Telecom, Tech",
                "target_geo": "Global",
                "ttps": "T1059 - Command and Scripting Interpreter, T1106 - Native API",
                "associated_malware": "Volatile Cedar",
                "associated_tools": "Custom tools",
                "first_observed": "2012",
                "description": "Chinese group targeting telecommunications.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "HTTPBrowser",
                "associated_tools": "Metasploit",
                "first_observed": "2013",
                "description": "Chinese group targeting aerospace sector.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_geo": "Asia, US",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "KaiKui",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2014",
                "description": "Chinese group targeting governments.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "target_sectors": "Defense, Government",
                "target_geo": "US, Europe",
                "ttps": "T1059 - Command and Scripting Interpreter, T1105 - Ingress Tool Transfer",
                "associated_malware": "Scarab",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2015",
                "description": "Chinese threat actor.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "ttps": "T1566 - Phishing",
                "associated_malware": "Sina, Stub",
                "associated_tools": "Custom tools",
                "first_observed": "2014",
                "description": "Chinese group active in Middle East.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage + Financial",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Software, Gaming",
                "target_geo": "Global",
                "ttps": "T1190 - Exploit Public-Facing Application, T1059 - Command and Scripting Interpreter",
                "associated_malware": "WINTRI",
                "associated_tools": "Custom tools",
                "first_observed": "2015",
                "description": "Chinese group targeting software供应链.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "associated_malware": "LoudMiner",
                "associated_tools": "Custom miner",
                "first_observed": "2018",
                "description": "Chinese cryptomining operation.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Aerospace, Defense",
                "target_geo": "US, Middle East",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "StoneDrill",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2014",
                "description": "Sometimes misattributed to Iran.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                "name": "Naikon",
                "alias": "APT32, Cyber Jade",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Military, Maritime",
                "target_geo": "Southeast Asia",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter, T1083 - File Discovery",
                "associated_malware": "Naikon, NDisk",
                "associated_tools": "Cobalt Strike, Metasploit",
                "first_observed": "2012",
                "description": "Chinese group targeting maritime and naval.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "target_geo": "US, Europe",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "Tonto, Sysupdate",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2012",
                "description": "Chinese group targeting defense.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Defense, Government",
                "target_geo": "South Asia",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Caterpillar",
                "associated_tools": "Custom RATs",
                "first_observed": "2016",
                "description": "Chinese group targeting South Asia.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Tech, Gaming",
                "target_geo": "US, Asia",
                "ttps": "T1190 - Exploit Public-Facing Application",
                "associated_malware": "ShadowPad",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2018",
                "description": "Chinese group targeting gaming sector.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Tech, Telecom",
                "target_geo": "Southeast Asia",
                "ttps": "T1566 - Phishing",
                "associated_malware": "Polonium",
                "associated_tools": "Custom tools",
                "first_observed": "2017",
                "description": "Chinese group.",
                "risk_level": "medium",
            ...
            },
            {
                ...
                "target_geo": "Southeast Asia",
                "ttps": "T1190 - Exploit Public-Facing Application",
                "associated_malware": "Charcoal",
                "associated_tools": "Custom tools",
                "first_observed": "2017",
                "description": "Chinesegroup.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "motivation": "Espionage + Financial",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Healthcare, Gaming",
                "target_geo": "Global",
                "ttps": "T1190 - Exploit Public-Facing Application, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Winnti variants",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2019",
                "description": "Chinese subset of APT41.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "target_geo": "Europe",
                "ttps": "T1190 - Exploit Public-Facing Application",
                "associated_malware": "TERIOR",
                "associated_tools": "Custom tools",
                "first_observed": "2018",
                "description": "Chinese state actor.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 1,
            },
            ...
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Tech, Media",
                "target_geo": "US, Europe",
                "ttps": "T1190 - Exploit Public-Facing Application",
                "associated_malware": "Fsociety",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2018",
        ...
        "Israel": [
            ...
            },
            {
                ...
                "motivation": "Espionage + Sabotage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Critical Infrastructure",
                "target_geo": "Middle East",
                "ttps": "T1190 - Exploit Public-Facing Application, T1486 - Data Encrypted for Impact",
                "associated_malware": "Zero-day tools",
                "associated_tools": "Custom exploits",
                "first_observed": "2010",
                "description": "Israeli cyber warfare unit for offensive operations.",
                "risk_level": "critical",
                "country_region": "MEA",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Nuclear",
                "target_geo": "Global",
                "ttps": "T1566 - Phishing, T1078 - Valid Accounts",
                "associated_malware": "Custom spyware",
                "associated_tools": "Spear phishing",
                "first_observed": "2000",
                "description": "Mossad intelligence agency cyber division.",
                "risk_level": "critical",
                "country_region": "MEA",
                "active": 1,
            },
        ...
        "South Korea": [
            {
                ...
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense",
                "target_geo": "North Korea, China",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Korean malware variants",
                "associated_tools": "Custom RATs",
                "first_observed": "2013",
                "description": "South Korean intelligence-linked group.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense, Telecom",
                "target_geo": "Korea, Japan, US",
                "ttps": "T1566 - Phishing, T1190 - Exploit Public-Facing Application",
                "associated_malware": "DarkHotel, Karba",
                "associated_tools": "Zero-day exploits",
                "first_observed": "2007",
                "description": "Sophisticated Korean group targeting hotels and governments.",
                "risk_level": "high",
                "country_region": "APAC",
                "active": 0,
            },
        ...
        "Pakistan": [
            ...
            {
                "name": "Pakistan Monkey",
                "alias": "PM",
                "actor_type": "State-sponsored",
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense",
                "target_geo": "India, Afghanistan",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "Muddy",
                "associated_tools": "Custom RATs",
                "first_observed": "2017",
                "description": "Pakistani threat actor targeting military institutions.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
            {
                ...
                "motivation": "Espionage",
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Foreign Policy",
                "target_geo": "India, Bangladesh",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter, T1105 - Ingress Tool Transfer",
                "associated_malware": "LuminousRAT",
                "associated_tools": "Metasploit",
                "first_observed": "2019",
                "description": "Pakistani group targeting diplomatic entities.",
                "risk_level": "medium",
                "country_region": "APAC",
                "active": 1,
            },
        ...
        "Turkey": [
            ...
            },
            {
                ...
                "capabilities": "Advanced Persistent Threat",
                "target_sectors": "Government, Defense",
                "target_geo": "Middle East, Europe",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "AyasRAT",
                "associated_tools": "Custom tools",
                "first_observed": "2020",
                "description": "Turkish group targeting government institutions.",
                "risk_level": "medium",
                "country_region": "EMEA",
                "active": 1,
            },
            {
                ...
                "target_geo": "Middle East",
                "ttps": "T1190 - Exploit Public-Facing Application, T1566 - Phishing",
                "associated_malware": "HeavyTool",
                "associated_tools": "Cobalt Strike",
                "first_observed": "2019",
                "description": "Turkish APT focused on media entities.",
                "risk_level": "medium",
                "country_region": "EMEA",
                "active": 1,
            },
        ...
        "Brazil": [
            ...
            {
                "name": "Brazilian Banking Trojans",
                "alias": "BBT",
                "actor_type": "Criminal",
                "motivation": "Financial",
                "capabilities": "Banking trojan",
                "target_sectors": "Finance, Banking",
                "target_geo": "Brazil, Latin America",
                "ttps": "T1566 - Phishing, T1059 - Command and Scripting Interpreter",
                "associated_malware": "RDN trojans, Clipper",
                "associated_tools": "Custom trojans",
                "first_observed": "2015",
                "description": "Brazilian banking trojan operations.",
                "risk_level": "medium",
                "country_region": "South America",
                "active": 1,
            },
            {
                "name": "Portuguese Groups",
                "alias": "Anonymous Portugal",
                "actor_type": "Hacktivist",
                "motivation": "Hacktivism",
                "capabilities": "DDoS, Defacement",
                "target_sectors": "Government, Media",
                "target_geo": "Global",
                "ttps": "T1485 - Destruction, T1498 - Network Denial of Service",
                "associated_malware": "LoICs",
                "associated_tools": "DDoS tools",
                "first_observed": "2011",
                "description": "Portuguese hacktivist groups.",
                "risk_level": "low",
                "country_region": "EMEA",
                "active": 0,
            },
    ...
    # Class-level attribute for malware aliases
    MALWARE_ALIASES = {
        "sysupdate": ["hyperbro", "sysupdate", "aspyspy", "toadie"],
        "hyperbro": ["hyperbro", "sysupdate", "aspyspy"],
        "winnti": ["winnti", "winnti-srv", "shadowpad"],
        "shadowpad": ["shadowpad", "winnti"],
        "cobalt strike": ["cobalt strike", "beacon"],
        "sofacy": ["sofacy", "xagent", "sedre"],
        "chinasp": ["chinasp", "chinatoo"],
        "tonto": ["tonto", "taints", "bisonal"],
        "poisonivy": ["poisonivy", "poison ivy"],
        "crimson rat": ["crimson", "crimson rat"],
        "habo": ["habo", "hworm"],
        "sysprint": ["sysprint", "macen"],
        "chrome": ["chrome", "chrome-eb"],
        "carbanak": ["carbanak", "navigator"],
        "dridex": ["dridex", "bitpaymer"],
        "emotet": ["emotet", "heodo"],
        "trickbot": ["trickbot", "trickster"],
        "icedid": ["icedid", "bokbot"],
        "qakbot": ["qakbot", "qbot"],
        "iocs": ["iocs", "remcos"],
        "ratankba": ["ratankba", "pangrat"],
        "gazer": ["gazer", "krypton"],
        "turla": ["turla", "snake", "uroboros"],
        "fin7": ["fin7", "carbanak"],
        "apt29": ["apt29", "cozy bear", "sunburst"],
        "apt28": ["apt28", "fancy bear", "sofacy"],
        "notpetya": ["notpetya", "expetya"],
        "industroyer": ["industroyer", "crashoverride"],
    }

    def get_malware_links(self, malware_name: str) -> Dict[str, str]:
        """Get malware analysis links for various platforms"""
        if not malware_name:
            return {}

        # Clean up malware name
        clean_name = malware_name.strip().replace(" ", "%20")

        # Get alias names for better search coverage
        alias_names = self.MALWARE_ALIASES.get(clean_name.lower(), [clean_name])

        # Create search links with multiple variants
        tag_search = ",".join([f"tag:{name}" for name in alias_names[:3]])

        return {
            "virustotal": f"https://www.virustotal.com/gui/search/?query={clean_name}",
            "malwarebazaar": f"https://bazaar.abuse.ch/browse.php?search={tag_search}",
            "malwarehaus": f"https://www.malwareurl.com/list/?search={clean_name}",
            "any_run": f"https://any.run/search?q={clean_name}",
            "hybrid_analysis": f"https://www.hybrid-analysis.com/search?search={clean_name}",
            "triage": f"https://tria.ge/reports?search={clean_name}",
            "threatfox": f"https://threatfox.abuse.ch/api/sxf/?query={clean_name}",
            "vt_api_search": f"https://www.virustotal.com/api/v3/search?query={clean_name}",
        }

    def get_all_malware_links(self, actor: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Get all malware links for an actor"""
        malware_list = []
        associated = actor.get("associated_malware", "")

        for malware in associated.split(","):
            malware = malware.strip()
            if malware:
                malware_list.append(
                    {
                        "name": malware,
                        "links": self.get_malware_links(malware),
                    }
                )

        return malware_list

    def get_opencti_status(self) -> Dict[str, Any]:
        """Get OpenCTI integration status"""
        return {
            "configured": False,
            "message": "Configure OpenCTI in settings to enable integration",
            "features": [
                "threat_actor_sync",
                "activity_reporting",
                "indicator_sync",
